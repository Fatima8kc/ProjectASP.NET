...
namespace CommandesG.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            var orders = from o in _context.Orders.Include(o => o.Customer).Include(o => o.Employee).Include(o => o.ShipViaNavigation)
                         select o;

            if (!String.IsNullOrEmpty(searchString))
            {
                orders = orders.Where(s => s.OrderId.ToString().Contains(searchString)
                                           || s.Customer.CustomerId.Contains(searchString));
            }
        ...
        {
            var order = await _context.Orders
                .Include(o => o.OrderDetails) // Charger les détails de commande associés
                .FirstOrDefaultAsync(m => m.OrderId == id);
